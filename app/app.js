...
const INTERVIEW_QUESTIONS = [
  {
    crystal: 1,
    level: "🔴 Кристалл 1 · Инстинкты и самосохранение",
    question: "Как ты реагируешь в ситуациях неопределённости или угрозы — финансовой, физической, в отношениях? Доверяешь ли телесным сигналам, и насколько сильно инстинкт самосохранения управляет твоими решениями?",
    simText: "В ситуациях угрозы я сначала оцениваю риски, стараюсь не паниковать. Мой инстинкт самосохранения проявляется прежде всего в финансовой осторожности — я редко иду на авантюры без расчёта. Тело тоже сигнализирует, и я научился прислушиваться к этим сигналам."
  },
  {
    crystal: 2,
    level: "🟠 Кристалл 2 · Творчество и созидание",
    question: "Расскажи, как ты проявляешь своё творческое начало. Ты больше создаёшь руками, идеями, словами? И насколько сильна в тебе потребность создавать что-то новое там, где его не было?",
    simText: "Я скорее творец идей — мне нравится придумывать концепции, которые другие потом воплощают. Иногда создаю что-то руками: пишу тексты, строю бизнес-модели. Для меня созидание — это создание нового там, где его не было."
  },
  {
    crystal: 3,
    level: "🟡 Кристалл 3 · Интуиция и исследование",
    question: "Когда принимаешь важное решение — больше доверяешь интуиции или логике? И насколько тебе важно исследовать и узнавать новое — о себе, о мире, об окружающих людях?",
    simText: "Я доверяю интуиции примерно на 60-70%, остальное — аналитика. Мне очень важно исследовать мир: постоянно читаю, изучаю новые области, наблюдаю за людьми. Самопознание — один из ключевых процессов в моей жизни."
  },
  {
    crystal: 4,
    level: "🟢 Кристалл 4 · Выражение и коммуникация",
    question: "Насколько легко тебе выражать свои мысли и идеи — публично или в личном разговоре? Ты больше любишь делиться устно, письменно? И легко ли говоришь о том, что важно лично для тебя?",
    simText: "Мне легко говорить один на один и в маленьких группах. Перед большой аудиторией волнуюсь, но это проходит. Предпочитаю делиться идеями через разговор, а не через тексты — живое общение точнее передаёт суть."
  },
  {
    crystal: 5,
    level: "🔵 Кристалл 5 · Воля и влияние",
    question: "Как ты мотивируешь себя действовать, когда нет внешнего давления? И есть ли у тебя опыт влияния на других людей — как ты их ведёшь или вдохновляешь?",
    simText: "Я мотивирую себя через цель и смысл — когда понимаю зачем, энергия появляется сама. Влияю на других через пример и разговор, редко через давление. Люди идут за мной, когда чувствуют искренность в том, что я делаю."
  },
  {
    crystal: 6,
    level: "💜 Кристалл 6 · Любовь и эмпатия",
    question: "Как ты проявляешь любовь и заботу — к близким, к людям вокруг, к природе, миру? Насколько ты способен чувствовать боль или радость другого человека как свою собственную?",
    simText: "Я проявляю любовь через поступки и внимание к деталям. Эмпатия у меня высокая — иногда даже слишком: могу сильно переживать проблемы другого человека. К природе и животным отношусь с глубоким уважением, чувствую с ними живую связь."
  },
  {
    crystal: 7,
    level: "🩵 Кристалл 7 · Аналитика и структура",
    question: "Насколько тебе важна структура, системность, расчёты? Ты любишь раскладывать всё по полочкам или предпочитаешь действовать интуитивно без жёстких планов и таблиц?",
    simText: "Структура для меня важна в работе, но в жизни оставляю место для гибкости. Анализирую данные перед решениями, люблю таблицы и планы, но не становлюсь их рабом. Мышление у меня системное, но не бюрократическое."
  },
  {
    crystal: 8,
    level: "🌸 Кристалл 8 · Эмоциональность и воображение",
    question: "Насколько ты эмоциональный человек? Легко показываешь чувства или держишь их при себе? И насколько богата твоя внутренняя жизнь — мечты, фантазии, образы будущего?",
    simText: "Я эмоциональный внутри, но сдержанный снаружи. Редко показываю чувства публично, но внутри всё очень живо. Воображение у меня богатое — часто представляю сценарии будущего, мечтаю, визуализирую. Это один из главных моих инструментов."
  },
  {
    crystal: 9,
    level: "✨ Кристалл 9 · Экзистенциальное мышление",
    question: "Задаёшься ли ты глубокими вопросами — зачем я здесь, что есть сознание, есть ли что-то за пределами физического мира? Насколько для тебя важны поиски смысла и как это влияет на твою жизнь?",
    simText: "Да, это одна из моих постоянных тем. Я не принимаю готовых ответов — мне важно самому исследовать. Вопрос о смысле жизни для меня не абстрактный, а практический: он влияет на то, как расставляю приоритеты и куда вкладываю время и энергию."
  }
];
