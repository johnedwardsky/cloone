...
/* DNA Matrix v2.0 — 10 тематических блоков, 20 косвенных вопросов             */
/* Техники: Т1-Зеркало · Т2-Проекция · Т3-Метафора · Т4-Якорь · Т5-Анти · Т6-Экстрим */

const INTERVIEW_QUESTIONS = [
  {
    block: 1, technique: 'Т2',
    level: '🪞 Блок 1 · Самовосприятие',
    question: 'Представь: незнакомец случайно нашёл твой телефон и 10 минут листал переписки, фото, заметки. Кем бы он тебя посчитал? И насколько он был бы прав?',
    hint: 'Расскажи свободно — нет правильного ответа',
    vectors: ['V21','V01','V22'], crystals: [4, 8],
    simText: 'Наверное решил бы что я трудоголик. Много рабочих чатов. Фото — природа и интересные места. Он был бы прав процентов на 70. Есть личная часть которую держу при себе.'
  },
  {
    block: 1, technique: 'Т1',
    level: '🪞 Блок 1 · Самовосприятие',
    question: 'Я, например, очень не люблю когда меня хвалят публично — даже заслуженно, меня это смущает. У тебя есть что-то похожее — что люди делают с добрыми намерениями, а тебя это напрягает?',
    hint: 'Даже мелочи — всё подходит',
    vectors: ['V22','V13','V04'], crystals: [4, 6],
    simText: 'Да. Когда люди дают советы которых я не просил. Из заботы понимаю. Но это меня раздражает — как будто они не верят что я справлюсь сам.'
  },
  {
    block: 2, technique: 'Т1',
    level: '🎯 Блок 2 · Движущие силы',
    question: 'Я меряю неделю не количеством сделанного, а тем — сдвинулось ли что-то важное вперёд, хотя бы чуть. Если нет — ощущение что неделя провалена. А ты как понимаешь что неделя была хорошей?',
    hint: 'Честно — как ты сам для себя это считаешь',
    vectors: ['V03','V05','V18'], crystals: [2, 5, 7],
    simText: 'Если я что-то создал — написал, запустил, придумал что-то работающее. Ещё если было время побыть в тишине и подумать. Если неделя только из встреч — чувствую себя потраченным, а не вложенным.'
  },
  {
    block: 2, technique: 'Т5',
    level: '🎯 Блок 2 · Движущие силы',
    question: 'Чем бы ты точно не занимался в жизни — сколько бы это ни приносило денег?',
    hint: 'Первое что пришло в голову',
    vectors: ['V03','V05','V06'], crystals: [2, 5],
    simText: 'Ничем однообразным. Одно и то же каждый день убивает меня изнутри. Ещё — работой где нет реального результата. Просто процесс ради процесса.'
  },
  {
    block: 3, technique: 'Т3',
    level: '🛡 Блок 3 · Безопасность и деньги',
    question: 'Если бы твои отношения с деньгами были персонажем из кино или книги — кто бы это был? Герой, злодей, случайный знакомый?',
    hint: 'Любая ассоциация — образ, характер, отношения',
    vectors: ['V17','V11'], crystals: [1, 7],
    simText: 'Строгий наставник. Я его уважаю, немного побаиваюсь, но учусь у него. Он требовательный но справедливый. Когда я его уважаю — он работает на меня.'
  },
  {
    block: 3, technique: 'Т4',
    level: '🛡 Блок 3 · Безопасность и деньги',
    question: 'Вспомни момент, когда тебе нужно было сказать что-то неприятное человеку прямо в лицо. Что ты сделал на самом деле?',
    hint: 'Не как «должен был», а как реально поступил',
    vectors: ['V20','V11','V22'], crystals: [1, 5, 6],
    simText: 'Сказал, но не сразу. Сначала несколько дней собирался. Потом всё же поговорил лично. Это было некомфортно, но я понял: если не сказать — всё только хуже.'
  },
  {
    block: 4, technique: 'Т1+Т4',
    level: '❤️ Блок 4 · Семья и близость',
    question: 'У моих родителей была привычка которую я ненавидел в детстве. Поклялся никогда так не делать. И ловлю себя на том что делаю именно это. Есть у тебя что-то такое?',
    hint: 'Любое, даже маленькое',
    vectors: ['V02','V22','V21'], crystals: [6, 1, 9],
    simText: 'Да. Мой отец всегда был занят работой — казалось что он рядом но отсутствует. Я обещал быть по-другому. Но иногда ловлю себя на том же — физически дома, а головой — на проекте.'
  },
  {
    block: 4, technique: 'Т2',
    level: '❤️ Блок 4 · Семья и близость',
    question: 'Как ты думаешь, что люди которых ты любишь никогда не скажут тебе в лицо — но думают?',
    hint: 'Первое что приходит — скорее всего самое точное',
    vectors: ['V02','V22','V13'], crystals: [6, 4],
    simText: 'Что я бываю недоступен. Не физически, а внутренне. Что мои мысли где-то далеко даже когда мы вместе. Наверное они правы.'
  },
  {
    block: 5, technique: 'Т2',
    level: '⏱ Блок 5 · Быт и ритуалы',
    question: 'Что ты делаешь, когда хочешь полностью выключить голову — не думать вообще ни о чём?',
    hint: 'То что реально работает, а не то что должно работать',
    vectors: ['V10','V12','V23'], crystals: [8, 1],
    simText: 'Еду на машине без конкретной цели. Музыка — и больше ничего. Или хожу пешком час-два. Движение помогает. Смотреть что-то в телефоне — нет, только усиливает шум.'
  },
  {
    block: 5, technique: 'Т5',
    level: '⏱ Блок 5 · Быт и ритуалы',
    question: 'Что ты точно не будешь делать в выходной день — даже если все говорят что это полезно?',
    hint: 'Без фильтра',
    vectors: ['V10','V18','V06'], crystals: [1, 2, 7],
    simText: 'Ходить на нетворкинг или корпоративные мероприятия. Даже если полезно. Выходной — это моё время, и я его не отдам чужим задачам.'
  },
  {
    block: 6, technique: 'Т5',
    level: '🌍 Блок 6 · Мировоззрение',
    question: 'Какую правду о людях или о мире ты давно перестал высказывать вслух — потому что разговор всегда идёт не туда?',
    hint: 'Можно конкретно, можно в общих словах',
    vectors: ['V15','V07','V08'], crystals: [9, 7],
    simText: 'Что большинство людей живут чужими ожиданиями и даже не задают себе вопрос — а чего хочу я. Когда говорю об этом — люди либо обижаются, либо спорят ни о чём.'
  },
  {
    block: 6, technique: 'Т6',
    level: '🌍 Блок 6 · Мировоззрение',
    question: 'Если бы тебе сказали что есть 6 месяцев жизни — что ты перестал бы делать в первую очередь? Не что начал, а именно перестал.',
    hint: 'Первая реакция честнее всего',
    vectors: ['V15','V21','V18'], crystals: [9, 5, 1],
    simText: 'Перестал бы объяснять себя людям которым я не обязан. Перестал бы откладывать разговоры которых боюсь. И точно перестал бы делать то что делаю из вежливости а не из смысла.'
  },
  {
    block: 7, technique: 'Т1+Т2',
    level: '🎨 Блок 7 · Эстетика и чувствительность',
    question: 'Я не могу слышать жевание рядом — физически выбивает из колеи. У тебя есть что-то похожее — странная сенсорная чувствительность о которой обычно не говоришь?',
    hint: 'Любая мелочь считается',
    vectors: ['V19','V12','V09'], crystals: [8, 7, 3],
    simText: 'Да. Не могу работать если в пространстве что-то визуально не так — асимметрия, беспорядок на столе. Сначала уберу — потом сяду. Ещё — резкие звуки. Сирены в тишине — это как игла.'
  },
  {
    block: 7, technique: 'Т4',
    level: '🎨 Блок 7 · Эстетика и чувствительность',
    question: 'Что последнее заставило тебя остановиться и смотреть на это дольше чем планировал? Не важно что — архитектура, песня, сцена из кино.',
    hint: 'Самый недавний пример',
    vectors: ['V19','V06','V24'], crystals: [8, 2],
    simText: 'Видео где объясняли теорию хаоса через визуальные паттерны. Просто смотрел и не мог оторваться. Красота структуры в хаосе — это что-то особенное.'
  },
  {
    block: 8, technique: 'Т2',
    level: '🗣 Блок 8 · Общение и конфликты',
    question: 'Что бы сказал о тебе человек который тебя не любит? Только честно — что в этом было бы правдой?',
    hint: 'Та часть которую ты сам знаешь за собой',
    vectors: ['V13','V20','V24'], crystals: [4, 5, 7],
    simText: 'Что я высокомерен с теми кто соображает медленнее. Это правда. Я стараюсь с этим работать но иногда прорывается — в мимике, в интонации.'
  },
  {
    block: 8, technique: 'Т1',
    level: '🗣 Блок 8 · Общение и конфликты',
    question: 'Я пользуюсь иронией как оружием — когда что-то идёт не так, начинаю деконструировать аргументы очень вежливо, но так что человек сам понимает. Ты используешь юмор стратегически?',
    hint: 'Как ты это делаешь — осознанно или нет',
    vectors: ['V24','V20','V13'], crystals: [4, 5, 6],
    simText: 'Да, похоже. У меня это бывает автоматически — начинаю задавать уточняющие вопросы пока человек сам не запутается в своей логике. Юмор я использую чтобы разрядить а не унизить.'
  },
  {
    block: 9, technique: 'Т1+Т4',
    level: '🧠 Блок 9 · Решения и интуиция',
    question: 'Я однажды принял лучшее решение в жизни полностью на эмоциях, игнорируя все цифры. И одно из худших — холодно, логично, с таблицей. Бывало у тебя что интуиция и анализ показывали в разные стороны? Кому ты в итоге доверился?',
    hint: 'Конкретный случай — самый показательный',
    vectors: ['V16','V14','V23'], crystals: [3, 7, 8],
    simText: 'Было. Один партнёр — все цифры хорошие, но внутри что-то не то. Я подавил интуицию, подписал. Через полгода вышел с потерями. С тех пор правило: если интуиция кричит нет — проект блокируется.'
  },
  {
    block: 9, technique: 'Т3',
    level: '🧠 Блок 9 · Решения и интуиция',
    question: 'Если твоё тело — это индикатор настроения. Как оно себя ведёт когда что-то идёт не так? Что первым даёт сигнал — голова, грудь, живот?',
    hint: 'Физически — что именно происходит',
    vectors: ['V12','V14','V23'], crystals: [1, 3, 8],
    simText: 'Живот. Ещё до того как я понимаю что происходит — там уже что-то сжалось. Потом плечи вверх. Голова включается последней и начинает придумывать объяснения тому что тело уже давно знает.'
  },
  {
    block: 10, technique: 'Т6+Т5',
    level: '🌑 Блок 10 · Тень и маска',
    question: 'Если бы ты мог нажать паузу прямо сейчас — не чтобы что-то починить, просто выдохнуть — куда бы ты исчез и что бы делал? Честно — не то что «должен», а то что хочется.',
    hint: 'Первый образ который пришёл',
    vectors: ['V08','V23','V07'], crystals: [1, 8, 9],
    simText: 'Уехал бы куда-то один. Незнакомый город, никто не знает кто я. Просто ходил бы, ел что попало, смотрел на людей. Без планов, без задач. Просто существовал бы.'
  },
  {
    block: 10, technique: 'Т1+Т5',
    level: '🌑 Блок 10 · Тень и маска',
    question: 'Есть вещи которые я говорю о себе публично и верю в них. А потом в 2 часа ночи понимаю что это не совсем правда. Есть у тебя история о себе которую рассказываешь — и сам уже почти поверил, но где-то внутри знаешь что это роль?',
    hint: 'Это самый важный вопрос. Можно говорить медленно.',
    vectors: ['V08','V21','V22'], crystals: [1, 8, 9],
    simText: 'Что мне не нужна помощь. Что я справлюсь сам. Это моя любимая история о себе. Она правда — в большинстве случаев. Но иногда устаю держать всё в одиночку, и тогда эта история становится ловушкой.'
  }
]
